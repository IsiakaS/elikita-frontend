...
export class PatientDataReviewComponent implements OnInit {
    ...
    addArrayItem(fieldApiName: string) {
        ...
        const dialogRef = this.dialog.open(DynamicFormsV2Component, {
            ...
            data: {
                formMetaData: {
                    formName: `Add New ${fieldDef.generalProperties.fieldLabel}`,
                    formDescription: `Add a new ${fieldDef.generalProperties.fieldLabel.toLowerCase()} entry`,
                    submitText: 'Add',
    ...
    editArrayItem(arrayFieldInfo: any) {
        ...
        const dialogRef = this.dialog.open(DynamicFormsV2Component, {
            ...
            data: {
                formMetaData: {
                    formName: `Edit ${field.generalProperties.fieldLabel} #${index + 1}`,
