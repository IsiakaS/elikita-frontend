...
export class TasksTableComponent implements tablePropInt {
  ...
  tableFilter: Map<string, any[]> = new Map([
    ...
    ['Due Date', ['today', 'yesterday', 'last7days', 'last30days', 'thismonth', 'lastmonth', 'thisyear', 'lastyear']],
  ...
  tableColumns: string[] = [
    'startDate', 'dueDate', 'name', 'type', 'for', 'assignedTo', 'status', 'actions'
  ]
